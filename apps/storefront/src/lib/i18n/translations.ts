...
const translations = {
  de: {
    ...
    related_products_body: "Diese Produkte könnten Sie ebenfalls interessieren.",
    ...
    product_specs_eyebrow: "Datenblatt",
    product_specs_title: "Technische Daten",
    product_highlights_title: "Highlights",
    product_detects_title: "Fehlerkatalog",
    ...
    hero_pill_2: "Lösungen für visuelle Inspektion",
    hero_pill_3: "Robotik-Automation für Life Sciences",
    hero_pill_4: "KI-Geschäftssysteme",
  ...
  en: {
    ...
    related_products_body: "You might also want to check out these products.",
    ...
    product_specs_eyebrow: "Data sheet",
    product_specs_title: "Technical specifications",
    product_highlights_title: "Key features",
    product_detects_title: "Defect catalogue",
    product_material: "Material",
    ...
    hero_pill_2: "Visual Inspection solutions",
    hero_pill_3: "Robotic automation for life sciences",
    hero_pill_4: "AI business systems",
