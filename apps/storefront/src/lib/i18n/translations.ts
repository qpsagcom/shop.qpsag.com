...
const translations = {
  de: {
    ...
    menu_store_desc: "ROVIS, Roboter, Testsets und Software",
    ...
    footer_tagline: "ROVIS-Roboter, Robotersysteme, Testsets, Software und Inspektionsboxen für die visuelle Inspektion in Pharma, Biotech und Food Tech.",
    ...
    home_feature1_body: "ROVIS und robotische Bausteine für wiederholbare Prüfprozesse in der regulierten Produktion.",
    ...
    home_cta_heading: "Von ROVIS bis Fehler-Testsets: Der Shop wird zur ersten Adresse für Robotik und visuelle Inspektion mit QPS Engineering Know-how.",
  ...
  en: {
    ...
    menu_store_desc: "ROVIS, robots, test sets, and software",
    ...
    footer_tagline: "ROVIS robots, robotics systems, test sets, software, and inspection boxes for visual inspection in pharma, biotech, and food tech.",
    ...
    home_feature1_body: "ROVIS and robotics building blocks for repeatable inspection processes in regulated production.",
    ...
    home_cta_heading: "From ROVIS to defect test sets: the shop becomes the first address for robotics and visual inspection with QPS Engineering know-how.",
