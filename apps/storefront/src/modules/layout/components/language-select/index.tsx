    ...
    <div>
      ...
      >
        ...
        <div className="flex relative w-full min-w-[320px]">
          ...
          >
            <ListboxOptions
              className="absolute -bottom-[calc(100%-36px)] left-0 z-[900] max-h-[442px] w-full overflow-y-scroll rounded-rounded border border-qps-line bg-qps-surface text-small-regular uppercase text-qps-ink shadow-[0_24px_70px_rgba(0,0,0,0.18)] no-scrollbar xsmall:left-auto xsmall:right-0"
              static
            >
              {options.map((o) => (
                <ListboxOption
                  key={o.code || "default"}
                  value={o}
                  className="flex cursor-pointer items-center gap-x-2 px-3 py-2 transition-colors hover:bg-qps-paper"
                >
                  {o.countryCode ? (
                    /* @ts-ignore */
                    <ReactCountryFlag
